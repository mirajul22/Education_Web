      ...
      <section>
        <div>
          <div className="h-[2488.66px] w-[780px] px-[15px]">
            <div className="h-[403.837px] w-[750px] max-w-full">
              <img
              ...
              <div className="h-[148.4px] w-full bg-white shadow-lg border-t-2 border-t-[#525fe1] flex items-center justify-center rounded-md">
                <p className="text-xl font-medium text-[#525fe1] flex items-center justify-center px-10">
